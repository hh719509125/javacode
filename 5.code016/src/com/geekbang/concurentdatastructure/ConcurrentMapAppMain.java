...
public class ConcurrentMapAppMain {
    public static void main(String[] args) {
        ...
        // TODO ConcurrentHashMap的kep和value都不允许为null
        // TODO Doug Lea 觉得 （我复议） 对线程并发环境下，key的值为null和key对应的只没有模棱两可的，所以干脆不支持
...
//        map.put("keyfornull", null);
        ...
        // TODO 所以虽然是尝试创建一个超出这个程序允许的大小的对象，但是因为已经有这个key了，所以lambda不会执行
