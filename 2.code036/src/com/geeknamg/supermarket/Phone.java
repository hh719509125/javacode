package com.geeknamg.supermarket;
...
public class Phone extends MerchandiseV2{
    ...
    // >> TODO 通过使用和父类方法签名一样，而且返回值也必须一样的方法，可以让子类覆盖（override掉父类的方法
    ...
    //    TODO 所以直接给属性赋值是危险的，因为没有办法检查新的指数否有意义，也没办法对这个修改做联动的修改

    public double buy(int count){

        // TODO 这个方法里代码大部分和父类一样，肯定有解决方法
    ...
    // >> TODO 这，就是多态
    // >> TODO 方法可以覆盖，属性访问不可以，所以这也是使用方法的原因
    ...
    // TODO 同样的，我们想着调用父类里的describe方法，试试看？
