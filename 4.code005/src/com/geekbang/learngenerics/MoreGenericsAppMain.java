...
public class MoreGenericsAppMain {
    public static void main(String[] args) {
        ...
        // >> TODO 这么传递参数步行，泛型不管继承关系，只管严格匹配
        // >> TODO 换句话说，Children 是 Parent 的子类，但是List<Children> 不是 List<Parent> 的子类
//        justG2Method(g3List);

        // >> TODO 那么怎么办呢？要让接收方，也就是形参，声明为协变泛型
        extMethod(g3List);

        // >> TODO 同样的道理，我们也可以创建协变的引用，让它可以接受的List引用的泛型类型为Parent或其子类
...
//        g2ListExt.add(new Children());
        ...
        // >> TODO 那就代表着，原本只应该有Children或者其子类的g30nlyList引用指向的对象，结果通过使用g2ListExt，被放进去了一个parent的实例
...
//        List<? super Parent> g2ListExt11 = new ArrayList<? super Parent>();
    }
