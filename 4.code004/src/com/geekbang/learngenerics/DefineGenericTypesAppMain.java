...
// >> TODO 泛型的作用包括：1) 告诉编译器帮我们检查类型是否匹配，类型是什么部重要，类型一样才重要；
// >> TODO             2) 在使用的地方帮我们做类型强制转换
...
//        String anther = (String) test.getAnother(new Object());


        // >> TODO 如果泛型信息缺失了，编译器也午饭帮忙检查出类型不匹配，只能给出 unchecked 编译警告
