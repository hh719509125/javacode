...
//        useStringList();
    ...
    // >> TODO 我知道没有用，我的告诉Java说这个List里只有String，方法就是使用泛型
    private static List<String> createStringListGenerics(){
        // TODO >> 泛型的语法是在支持泛型的类型上，给出类型的定义
        // TODO >> List的接口是支持泛型的，类型就是List里允许的元素类型
        // TODO >> 创建List实例和引用的时候，都可以（非必要）指定泛型对应的类型
        // TODO >> 不指定，那就是Object，所以我们之前用的List的元素就是Object类型的
