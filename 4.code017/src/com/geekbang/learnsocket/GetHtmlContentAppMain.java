...
public class GetHtmlContentAppMain {
    public static void main(String[] args) throws IOException {
        System.out.print("解析域名.....");
        InetAddress inetAddress = InetAddress.getByName("www.hao123.com");
        System.out.print("网站地址为：" + inetAddress);
        System.out.print("尝试连接到主机.....");
        Socket s = new Socket();
        SocketAddress sa = new InetSocketAddress(inetAddress, 80);
        s.connect(sa, 10000);
        System.out.print("已经连接到主机，开始模拟发送http请求.....");
        ...
        System.out.print("请求已经发送，开始读取主页内容.....");
        ...
        // TODO 这个程序对很多技术上有高标准追求的网站都已经不能工作了。即使能工作，也不能完整的读取网页内容
        // TODO 这里涉及到HTTP协议等内容，我们在这里就不详述了
        // TODO Java 有很多的HTTP库可以处理http客户端请求，我们在这里只是出于学习的目的，大概了解
        // TODO 我很欣慰看到网站已经都用FUT-8了，乱码基本成为了历史
    }
}
