...
public class MerchandiseV2 {
    ...
    // >> TODO 这样做的好处是，如果需要，可以通过代码，检查每个属性值是否合法
    private String name;
    private String id;
    private int count;
    ...
    // >> TODO 构造方法如果是private的，那么只有当前类可以调用这个构造方法
    ...
    // >> TODO 有些时候，会把所有的光谱噪方法都定义成private的，然后使用静态方法调用构造方法
    ...
    // >> TODO 对于private的方法，因为类外面调不到，所以无论怎么改，也不会影响（直接影响）类外面的代码
