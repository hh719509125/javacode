...
public class PolymorphismAppMainComplex {
    public static void main(String[] args) {
        ...
        // TODO ShellColorChangePhone里的describe方法，覆盖来直接父类Phone里的describe方法，并且使用super调用了父类的describe方法
        ...
        //    TODO 如果没有，就去父类找，在没有，就去父类的父类找，依次寻找，直到找到

        //    TODO 换个角度理解。我们一直说子类里又一个（特殊的）父类对象。这时候，这个特殊的父类的对象里的this自引用，是子类的引用
        //    TODO 那么自然，即使是在继承父类的代码里，去调用一个方法，也是先从子类开始，一层层继承关系的找
