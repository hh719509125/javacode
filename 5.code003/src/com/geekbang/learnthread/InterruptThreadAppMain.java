...
public class InterruptThreadAppMain {
    ...
    private static final String TEXT = "太阳在这个平静的小村庄缓缓地升起，又是开始了平常的一天。我们故事的主人公睡眼惺忪的的起来\n" +
            ".........";
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        for (int i = 0; i <= 1; i++){
            Thread thread = new Thread(new PrintStoryRunnable(TEXT, 200 * i));
...
//            thread.stop();
        ...
        // TODO 使用 TimeUnit 可以方便的进行时间单位之间的的换算
        Thread.sleep(TimeUnit.SECONDS.toMillis(5));

        System.out.println("线程启动结束，名字叫做" + Thread.currentThread().getName());
    }
