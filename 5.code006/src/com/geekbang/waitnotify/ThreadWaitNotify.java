...
public class ThreadWaitNotify {
    public static void main(String[] args) throws InterruptedException{
            ...
            new Thread(() -> {
                ...
                try {
                    synchronized (locker){
                        ...
                        // >> TODO 执行 wait 方法后，自动失去对象的 monitor，也就是说别的线程可以进入这个对象的synchronized代码块了
                        locker.wait();
                        // >> TODO 被唤醒的线程，就相当于执行过了wait方法，开始向下执行了
                        // >> TODO 如果 wait 不是synchronized块中的最后一行，那么第一件事就是“排队”获取之前失去的monitor
        ...
        // >> TODO 如果notify/notifyAll在wait之前，会怎样？
        ...
        // TODO 人工划重点：如果让缓刑的线程 sleep 的比worker短（sleep 时间 +1变 -1，或者干脆不sleep），也就是先进行notify，那么就可能造成这个问题
        // TODO 人工划重点: 为什么说可能呢？因为synchronized还是阻碍了notify的执行
