...
public class ThreadPoolAppMain {
    public static void main(String[] args) {
        ...
        // TODO 关闭线程池，shutdown方法会等待所有自己已经提交的任务完成，然后释放所有资源
        // TODO 正常应该在应用程序要结束的时候，将线程池关闭，这里我们是为了演示，提交任务就关闭
...
//        System.out.println("任务提交完毕");
//        // TODO 关闭线程，shutdown方法会等待所有已经提交的任务完成，然后释放所有资源
//        // TODO 正常应该在应用程序需结束的时候，将工作线程关闭，这里我们是为了演示，提交任务就关闭
//        System.out.println("关闭线程");
//        executorService.shutdown();
    }


    public static void printExecutionThreadStatus(String phase){
        System.out.println(Thread.currentThread().getName() + ":这里实在线程池里的执行代码: " + phase);
    }
}
