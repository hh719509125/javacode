...
public class Phone extends MerchandiseV2{
    ...
    public Phone(){
        ...
        init(4.5, 4.6, 6,128, "Uknown", "Ukbown");
    }

    private void init(double screenSize, double cpuHZ, int memoryG, int storageG, String brand, String os) {
    ...
    public double buy(int count){
        if (count > MAX_BUY_ONE_ORDER){
            System.out.println("购买失败，手机一次只能购买" + MAX_BUY_ONE_ORDER + "个");
            return -2;
        }
