...
import src.com.geekbang.supermarket.LittleSuperMarket;
import src.com.geekbang.supermarket.MerchandiseV2;
...
public class RunLittleSupperMarketAppMainExample {
    ...
    public static void main(String[] args) {
        ...
        //为了方便，创建一个商品数组引用，和littleSuperMarket.merchandise指向一个对象
        ...
        for (int i = 0; i < all.length; i++) {
            ...
            m.id = "Id" + i;
            //用创建的商品，给商品数组的第1个引用赋值，all和小超市的商品数组引用指向的是同一个数组对象
            all[i] = m;
        }
        ...
        while (true){
            System.out.println("今日超市大特惠，所有商品第二件半价！请选择商品的索引：");
            ...
            int hallPriceCount = numToBuy - fullPriceCount;

            double totalCost = fullPriceCount * m.soldPrice + (hallPriceCount * m.soldPrice / 2);
