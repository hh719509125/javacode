...
public interface ExpireDateMerchandise {
    ...
    /**
     * 根据剩余的有效期百分比，得出商品现在的实际的价值
     * @param lefDatePercentage 剩余有效期百分比
     * @return 剩余的实际价值
     */
    double actualValueNow(double lefDatePercentage);
