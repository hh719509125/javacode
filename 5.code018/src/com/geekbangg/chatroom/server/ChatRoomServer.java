package com.geekbangg.chatroom.server;

import com.geekbangg.chatroom.common.ChatMessage;
import com.geekbangg.chatroom.common.DataExchange;
...
import static com.geekbangg.chatroom.common.Constants.*;
import static com.geekbangg.chatroom.common.Utils.isValidUserName;
        ...
        private void handleServerCommand(ChatMessage chatMessage){
            DataExchange from = name2DataEx.get(chatMessage.getFrom());
                ...
                if (command.equalsIgnoreCase(SERVER_COMMAND_LOGOFF)){
                    ...
                    String allName = getAllNames();
                    from.send(new ChatMessage(ADMIN_NAME, chatMessage.getFrom(), "所有在线用户：" + allName));
                }
            }
