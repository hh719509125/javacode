...
public class UsePhoneHasMerchandise {
    public static void main(String[] args) {
        ...
        // TODO 所有和商品相关的操作，我们要先从Phone里获得商品的引用，然后在通过这个引用操作商品
        phone.getMerchandise().describe();

        // TODO 如果我们想要让手机返回不一样的商品名字，比如加上手机厂商型号，其实可以做到，但是不容易
        // TODO 我们可以在每次修改手机的厂商和型号的时候，都去set一下商品的名字，繁琐，但是的做到
        phone.getMerchandise().getName();

        // TODO 如果我们要限制购买数量不超过5怎么办？来一补继承
