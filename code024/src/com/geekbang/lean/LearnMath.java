...
public class LearnMath {
    ...
    public static void main(String[] args) {
        ...
        // TODO 原来归根结底，Math的random使用的Random类来实现的。他在java.util包里
        Random random = new Random();
       for (int i = 0; i < 100; i++){
            // TODO nextInt的返回值竟然有正数有负数哦！所以使用别人的类之前，一定要看看文档，避免出现问题
           System.out.println(Math.abs(random.nextInt()));
       }

       //Math.abs()取绝对值；Math.round()取整数。
