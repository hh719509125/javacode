...
public class RunLittleSupperMarketAppMain2 {
    public static void main(String[] args) {
        ...
        while (open){
            System.out.println("超市叫做" + littleSuperMarket.superMarketName);
            System.out.println("超市地址" + littleSuperMarket.address);
            ...
            if (customer.isDrivingCar){
                if (littleSuperMarket.parkingCount > 0){
                    ...
                    System.out.println("不好意思，没有停车位了，请下次再来");
                    continue;
                }
            }else {
            ...
            while (true){
                ...
                if (numToBuy > m.count){
                    System.out.println("本店库存不足，欢迎继续挑选");
                    continue;
                }
        ...
        System.out.println("今天总的营业额为：" + littleSuperMarket.incomingSum + ".营业情况为下");
        ...
        for (int i = 0; i < littleSuperMarket.merchandiseSold.length; i++){
            ...
            if (numSold > 0){
                ...
                System.out.println(m.name + "出售了" + numSold + "个。销售额为"
                        + incoming + "净利润为" + netIncomming);
            }
        }
    }
}
