package com.geekbang.learnthre;

public class CreateThreadAppMain {

    private static final String TEXT = "太阳在这个平静的小村庄缓缓升起，又是开始了平静的一天。我们故事的主人公睡眼惺忪的起来\n" +
            "......";
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 2; i++){
            // TODO 学习创建线程的方法
            // TODO Runnable接口里的run是线程执行的方法，执行完毕线程就结束了
            ...
            // TODO 创建好线程后，如果要启动线程，必须调用start方法，注意不是run方法
            thread.start();
        }
